...
typedef struct {
    ValveStat   stat_valve_cold  : 2;       //статус электропривода
    ValveError  error_valve_cold : 2;       //код ошибки электропривода
    ValveStat   stat_valve_hot   : 2;       //статус электропривода
    ValveError  error_valve_hot  : 2;       //код ошибки электропривода
    LeakStat    leak1 : 1;                  //состояние датчика утечки #1
    LeakStat    leak2 : 1;                  //состояние датчика утечки #2
